...
public class RobotContainer {
  ...
  private final CommandXboxController m_Xbox_Manette1 = new CommandXboxController(Constants.ControllerConstants.MANETTE_PILOTE1_ID);


  private final Joystick m_joystick =  new Joystick(Constants.ControllerConstants.MANETTE_PILOTE1_ID);
  private final double m_pourcentageVitesse = 0.5;
  ...
  private final CommandXboxController m_driverController =
      new CommandXboxController(Constants.ControllerConstants.MANETTE_PILOTE1_ID);
  ...
  private void configureDefaultCommands() {
    m_BasePilotable_SS.setDefaultCommand(m_DriveWJoystick_CMD);
